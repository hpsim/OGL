...
//           loc.row_idxs.insert(loc.row_idxs.end(), non_loc.row_idxs.get_data() + begin,
//                           non_loc.row_idxs.get_data() + end);
//           loc.col_idxs.insert(loc.cols.end(), non_loc.col_idxs.get_data() + begin,
...
//           ldu_mapping.insert(ldu_mapping.end(), non_loc.col_idxs.begin() + begin,
//                              non_loc.col_idxs.begin() + end);
